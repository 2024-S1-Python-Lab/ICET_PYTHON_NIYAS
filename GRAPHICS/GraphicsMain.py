...
# from graphicss.circle import area as circ_area, perimeter as circ_perimeter
# r=float(input("enter radius of a circle"))
# print("Circle - Area:", circ_area(r))
# print("Perimeter:", circ_perimeter(r))

# from graphics3d.cuboid import area as cuboid_area, perimeter as cuboid_perimeter
...
from graphics3d.sphere import area as sphere_area, perimeter as sphere_perimeter
